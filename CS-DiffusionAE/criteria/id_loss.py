...
from encoders.model_irse import Backbone

model_path = '/home/ids/yuhe/Projects/CA_with_GAN/3_code/styleGAN/pretrained_models/pSp_models/model_ir_se50.pth'
...
class IDLoss(nn.Module):
    def __init__(self):
        ...
        self.facenet.load_state_dict(torch.load(model_path, weights_only=True))
...
class IDLoss_new(nn.Module):
    def __init__(self):
        super(IDLoss_new, self).__init__()
