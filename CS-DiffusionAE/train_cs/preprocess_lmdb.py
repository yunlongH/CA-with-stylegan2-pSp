...
save_path = "datasets/preprocessed/ffhq_bg_glasses"

os.makedirs(f"{save_path}/logs", exist_ok=True)

image_folder = "/home/ids/yuhe/Projects/CA_with_GAN/2_data/styleGAN/ffhq_cs/train_glass"
lmdb_path = f"{save_path}/train_t.lmdb"
