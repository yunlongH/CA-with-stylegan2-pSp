...
from configs.data_paths import DATASETS   # <-- import here for Literal[...] and any runtime checks
...
class DataArgs:
    ...
    def __post_init__(self):
        # If the dataset field is still the MISSING sentinel, skip validation:
        if self.dataset is MISSING:
            return
...
class ModelArgs:
    ...
    workers: int = 4
    checkpoint_path: str = ""
    w_space_encoder: str = "pSp"
    stylegan_size: int = 1024
    encoder_type:  str = "pSp"
